...
test('should correctly parse reference names from HTML', async () => {
...
test('should correctly parse reference content from HTML', async () => {
  const references = await getReferencesMatchingPhrase('love others');
...
test('should correctly parse reference ID from HTML', async () => {
  const references = await getReferencesMatchingPhrase('love others');
