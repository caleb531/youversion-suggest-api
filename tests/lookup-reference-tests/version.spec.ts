...
test('should match versions containing non-ASCII characters', async () => {
...
test('should match versions irrespective of case', async () => {
...
test('should match versions irrespective of surrounding whitespace', async () => {
...
test('should match versions by partial name', async () => {
...
test('should match versions by ambiguous partial name', async () => {
...
test('should try to find closest match for nonexistent versions', async () => {
...
test('should match versions by exact name', async () => {
...
test('should use default version for nonexistent versions with no matches', async () => {
...
test('should use default version for nonexistent fallback versions', async () => {
...
test('should use correct ID for versions', async () => {
