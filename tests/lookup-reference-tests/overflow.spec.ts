...
test('should constrain specified verse to last verse if too high', async () => {
...
test('should constrain specified end verse to last endverse if too high', async () => {
...
test('should revert to single verse if verse and end verse are too high', async () => {
